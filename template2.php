...
class Template
{
	...
	{ ?>
		...
		<head>
			...
			<!-- Custom CSS -->
			<link rel="stylesheet" type="text/css" href="https://www.bard.edu/bluecher/main.css">
			<!-- Bootstrap CSS, JS -->
			<link rel="stylesheet" type="text/css" href="https://www.bard.edu/bluecher/css/bootstrap.css">
			<script src="https://www.bard.edu/bluecher/bootstrap.bundle.min.js"></script>
					...
					<div class="collapse navbar-collapse" id="BILnav">
						<ul class="navbar-nav mx-auto">
							<li class="nav-item me-2">
								<a class="nav-link" href="https://www.bard.edu/bluecher/index.php" style="color: #b18b2d !important;">Blücher Archive</a>
							</li>
							<li class="nav-item me-2 dropdown">
								...
								<div class="dropdown-menu">
									<a class="dropdown-item" href="https://www.bard.edu/bluecher/history.php">History</a>
									<a class="dropdown-item" href="https://www.bard.edu/bluecher/memorial.php">Memorial</a>
									<a class="dropdown-item" href="https://www.bard.edu/bluecher/add-articles.php">Additional Articles</a>
								</div>
							</li>
							<li class="nav-item me-2">
		...
		{ ?>
			...
			<div style="background-color: #333; color: white;" class="page-bottom footer">
